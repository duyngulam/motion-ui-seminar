            ...
            >
              <div className="bg-gray-900 text-cyan-100 rounded-2xl p-8 max-w-md w-full shadow-xl text-center border border-cyan-700/50">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Khi modal xuất hiện, nền mờ đi giúp người dùng tập trung vào nội dung chính —
                  tăng cảm xúc, giảm nhiễu, và làm rõ trọng tâm hành động.
                </p>
                <button
                  onClick={() => setOpen(false)}
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-5xl mx-auto mt-6">
          ...
          >
            ...
            <ul className="space-y-3 text-gray-200">
              <li>Motion UI (Motion User Interface) là nghệ thuật sử dụng chuyển động, hiệu ứng động, và hoạt ảnh trong giao diện người dùng.</li>
              <li>Nó giúp tăng khả năng tương tác, dẫn hướng người dùng, và tạo trải nghiệm hấp dẫn.</li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-2xl font-bold text-cyan-400 mb-3">Bối cảnh ra đời</h3>
            <ul className="space-y-3 text-gray-200">
              <li>Khi web và app ngày càng phong phú, người dùng không chỉ muốn “xem” mà còn muốn “cảm nhận”.</li>
              <li>Các nhà thiết kế UI/UX nhận ra: chuyển động là ngôn ngữ tự nhiên nhất để truyền tải ý nghĩa và cảm xúc trong giao diện.</li>
            </ul>
          </motion.div>
        </div>
      </Slide>
      ...
      <Slide index={3} bgColor="bg-gradient-to-b from-gray-900 to-black"
        ...
        <ul className="text-left list-disc max-w-2xl mx-auto space-y-3">
          ...
          <li>
            <strong>Tạo thương hiệu và sự chuyên nghiệp:</strong> Logo Google biến đổi khi tải
            <video
        ...
        <div className="text-left max-w-4xl mx-auto space-y-8 mt-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-200 space-y-2">
              <li>Hiệu ứng phải có lý do: hướng dẫn, phản hồi hoặc làm rõ mối quan hệ.</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-200 space-y-2">
              ...
              <li>“Ease-in” và “ease-out” giúp chuyển động mượt và tự nhiên.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-200 space-y-2">
              <li>Mọi hiệu ứng nên tuân theo cùng quy tắc: tốc độ, hướng, phong cách.</li>
            </ul>
          </div>
          ...
          <div className="pt-8 border-t border-gray-700">
            ...
            <p className="text-gray-300 mb-4">
              Trong ứng dụng ngân hàng, khi người dùng bấm <em>“Chuyển tiền”</em>:
              <br /> Nút đổi màu xanh → hiển thị loading → hiện dấu check ✅ → thông báo
              “Giao dịch thành công” mượt mà.
            </p>
        ...
        >
          ...
          <tbody>
            <tr className="border-t border-gray-700 hover:bg-gray-800/50 transition-colors">
              <td className="py-2 px-4 font-semibold">GSAP (GreenSock)</td>
              <td className="py-2 px-4">Mạnh mẽ, hiệu năng cao, dùng cho animation phức tạp</td>
              <td className="py-2 px-4">Web, game, landing page</td>
            </tr>
            <tr className="border-t border-gray-700 hover:bg-gray-800/50 transition-colors">
              <td className="py-2 px-4 font-semibold">Framer Motion</td>
              <td className="py-2 px-4">Thư viện cho React, dễ tạo hiệu ứng UI</td>
              <td className="py-2 px-4">Web app React</td>
            </tr>
            <tr className="border-t border-gray-700 hover:bg-gray-800/50 transition-colors">
              <td className="py-2 px-4 font-semibold">Anime.js</td>
              <td className="py-2 px-4">Tạo animation bằng JS đơn giản</td>
              <td className="py-2 px-4">Web hiện đại</td>
            </tr>
            <tr className="border-t border-gray-700 hover:bg-gray-800/50 transition-colors">
              <td className="py-2 px-4 font-semibold">Motion UI (ZURB Foundation)</td>
              <td className="py-2 px-4">Framework hiệu ứng dựa trên Sass</td>
...
>
  <div className="text-left max-w-5xl mx-auto mt-10">
    ...
    >
      <thead className="bg-gray-800 text-cyan-300">
        <tr>
          <th className="py-3 px-4 text-left text-lg font-semibold">Ứng dụng</th>
          <th className="py-3 px-4 text-left text-lg font-semibold">Cách sử dụng Motion UI</th>
        </tr>
      </thead>
  ...
  <div className="max-w-5xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-10 perspective-[1000px]">
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-cyan-800/60 to-gray-800/80 border border-cyan-500/40 rounded-2xl shadow-lg p-6 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-cyan-300 mb-3">Tăng tính tương tác</h3>
        <p className="text-gray-100">Làm giao diện sinh động và hấp dẫn người dùng.</p>
      </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-red-800/60 to-gray-900/80 border border-red-500/40 rounded-2xl shadow-lg p-6 rotateY-180 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-red-300 mb-3">Nhược điểm</h3>
        <p className="text-gray-100">Nếu lạm dụng dễ gây rối mắt và mất tập trung.</p>
      </div>
    </motion.div>
    ...
    >
      {/* Mặt trước */}
      <div className="absolute inset-0 bg-gradient-to-b from-cyan-800/60 to-gray-800/80 border border-cyan-500/40 rounded-2xl shadow-lg p-6 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-cyan-300 mb-3">Cải thiện trải nghiệm</h3>
        <p className="text-gray-100">Giúp người dùng hiểu rõ trạng thái & hành động.</p>
      </div>

      {/* Mặt sau */}
      <div className="absolute inset-0 bg-gradient-to-b from-red-800/60 to-gray-900/80 border border-red-500/40 rounded-2xl shadow-lg p-6 rotateY-180 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-red-300 mb-3">Nhược điểm</h3>
        <p className="text-gray-100">Tốn nhiều tài nguyên và công sức khi triển khai.</p>
      </div>
    </motion.div>
    ...
    >
      {/* Mặt trước */}
      <div className="absolute inset-0 bg-gradient-to-b from-cyan-800/60 to-gray-800/80 border border-cyan-500/40 rounded-2xl shadow-lg p-6 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-cyan-300 mb-3">Tạo phong cách thương hiệu</h3>
        <p className="text-gray-100">Giúp sản phẩm nổi bật và nhất quán hình ảnh.</p>
      </div>

      {/* Mặt sau */}
      <div className="absolute inset-0 bg-gradient-to-b from-red-800/60 to-gray-900/80 border border-red-500/40 rounded-2xl shadow-lg p-6 rotateY-180 backface-hidden flex flex-col justify-center text-center">
        <h3 className="text-xl font-bold text-red-300 mb-3">Nhược điểm</h3>
        <p className="text-gray-100">Khó duy trì nhất quán khi sản phẩm mở rộng.</p>
      </div>
    </motion.div>
  </div>
      </Slide>
...
>
  <div className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto mt-16 space-y-8">
    ...
    >
      ...
      giữa <span className="font-semibold text-cyan-200">công nghệ</span> và <span className="font-semibold text-cyan-200">cảm xúc</span>.
    </motion.p>
